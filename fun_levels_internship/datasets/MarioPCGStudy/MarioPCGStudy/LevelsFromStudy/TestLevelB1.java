...
public class TestLevelB1 extends Level{
	...
	private static Random levelSeedRandom = new Random();
		...
		public TestLevelB1(int width, int height)
	    {
			super(width, height);
	    }


		public TestLevelB1(int width, int height, long seed, int difficulty, int type, GamePlay playerMetrics)
	    {
	        this(width, height);
	    ...
	    public void creat(long seed, int difficulty, int type)
	    {
			...
			setBlock(73, 4, Level.BLOCK_EMPTY);
			setBlock(74, 4, Level.BLOCK_EMPTY);
			setBlock(75, 4, Level.BLOCK_EMPTY);
			setBlock(76, 4, Level.BLOCK_POWERUP);
			setBlock(77, 4, Level.BLOCK_EMPTY);
			setBlock(168, 4, Level.BLOCK_POWERUP);
			setBlock(191, 4, Level.BLOCK_COIN);
			setSpriteTemplate(14, 12, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
			setBlock(84, 8, Level.BLOCK_EMPTY);
			setBlock(85, 8, Level.BLOCK_EMPTY);
			setBlock(86, 8, Level.BLOCK_EMPTY);
			setBlock(181, 8, Level.TUBE_TOP_LEFT);
			setBlock(182, 8, Level.TUBE_TOP_RIGHT);
			setBlock(11, 9, Level.BLOCK_EMPTY);
			setBlock(12, 9, Level.BLOCK_EMPTY);
			setBlock(114, 9, Level.ROCK);
			setBlock(115, 9, Level.BLOCK_EMPTY);
			setBlock(129, 9, (byte) (14 + 0 * 16));
			setBlock(181, 9, Level.TUBE_SIDE_LEFT);
			setBlock(182, 9, Level.TUBE_SIDE_RIGHT);
			setBlock(42, 10, Level.ROCK);
			setBlock(114, 10, Level.ROCK);
			setBlock(129, 10, (byte) (14 + 1 * 16));
			setBlock(142, 10, Level.ROCK);
			setBlock(144, 10, Level.ROCK);
			setBlock(147, 10, Level.ROCK);
			setBlock(175, 10, Level.ROCK);
			setBlock(181, 10, Level.TUBE_SIDE_LEFT);
			setBlock(182, 10, Level.TUBE_SIDE_RIGHT);
			setBlock(184, 10, Level.TUBE_TOP_LEFT);
			setBlock(185, 10, Level.TUBE_TOP_RIGHT);
			setBlock(7, 11, Level.ROCK);
			setBlock(8, 11, Level.ROCK);
			setBlock(22, 11, Level.TUBE_TOP_LEFT);
			setBlock(23, 11, Level.TUBE_TOP_RIGHT);
			setBlock(29, 11, Level.TUBE_TOP_LEFT);
			setBlock(30, 11, Level.TUBE_TOP_RIGHT);
			...
			setBlock(61, 11, Level.ROCK);
			setBlock(62, 11, Level.ROCK);
			setBlock(63, 11, Level.ROCK);
			setBlock(64, 11, Level.ROCK);
			setBlock(65, 11, Level.ROCK);
			setBlock(66, 11, Level.ROCK);
			setBlock(81, 11, Level.ROCK);
			setBlock(82, 11, Level.ROCK);
			setBlock(90, 11, Level.TUBE_TOP_LEFT);
			setBlock(91, 11, Level.TUBE_TOP_RIGHT);
			setBlock(99, 11, Level.TUBE_TOP_LEFT);
			setBlock(100, 11, Level.TUBE_TOP_RIGHT);
			setBlock(111, 11, Level.TUBE_TOP_LEFT);
			setBlock(112, 11, Level.TUBE_TOP_RIGHT);
			setBlock(114, 11, Level.ROCK);
			setBlock(115, 11, Level.ROCK);
			setBlock(129, 11, (byte) (14 + 2 * 16));
			...
			setBlock(144, 11, Level.ROCK);
			setBlock(145, 11, Level.ROCK);
			setBlock(146, 11, Level.ROCK);
			setBlock(147, 11, Level.ROCK);
			setBlock(148, 11, Level.ROCK);
			setBlock(149, 11, Level.ROCK);
			setSpriteTemplate(158, 11, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
			setBlock(174, 11, Level.ROCK);
			setBlock(175, 11, Level.ROCK);
			setBlock(176, 11, Level.ROCK);
			setBlock(177, 11, Level.ROCK);
			setBlock(178, 11, Level.ROCK);
			setBlock(181, 11, Level.TUBE_SIDE_LEFT);
			setBlock(182, 11, Level.TUBE_SIDE_RIGHT);
			setBlock(184, 11, Level.TUBE_SIDE_LEFT);
			setBlock(185, 11, Level.TUBE_SIDE_RIGHT);
			setBlock(189, 11, Level.TUBE_TOP_LEFT);
			setBlock(190, 11, Level.TUBE_TOP_RIGHT);
			setBlock(1, 12, Level.ROCK);
			setBlock(2, 12, Level.ROCK);
			setBlock(3, 12, Level.ROCK);
			setBlock(4, 12, Level.ROCK);
			setBlock(5, 12, Level.ROCK);
			setBlock(6, 12, Level.ROCK);
			setBlock(7, 12, Level.ROCK);
			setBlock(8, 12, Level.ROCK);
			setBlock(22, 12, Level.TUBE_SIDE_LEFT);
			setBlock(23, 12, Level.TUBE_SIDE_RIGHT);
			setSpriteTemplate(26, 12, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
			setBlock(29, 12, Level.TUBE_SIDE_LEFT);
			setBlock(30, 12, Level.TUBE_SIDE_RIGHT);
			...
			setBlock(61, 12, Level.ROCK);
			setBlock(62, 12, Level.ROCK);
			setBlock(63, 12, Level.ROCK);
			setBlock(64, 12, Level.ROCK);
			setBlock(65, 12, Level.ROCK);
			setBlock(66, 12, Level.ROCK);
			setBlock(67, 12, Level.ROCK);
			setBlock(68, 12, Level.ROCK);
			...
			setBlock(90, 12, Level.TUBE_SIDE_LEFT);
			setBlock(91, 12, Level.TUBE_SIDE_RIGHT);
			setBlock(99, 12, Level.TUBE_SIDE_LEFT);
			setBlock(100, 12, Level.TUBE_SIDE_RIGHT);
			setBlock(111, 12, Level.TUBE_SIDE_LEFT);
			setBlock(112, 12, Level.TUBE_SIDE_RIGHT);
			setBlock(114, 12, Level.ROCK);
			setBlock(115, 12, Level.ROCK);
			setBlock(129, 12, (byte) (14 + 2 * 16));
			...
			setBlock(153, 12, Level.ROCK);
			setBlock(154, 12, Level.ROCK);
			setBlock(155, 12, Level.ROCK);
			...
			setBlock(162, 12, Level.ROCK);
			setBlock(163, 12, Level.ROCK);
			setBlock(164, 12, Level.ROCK);
			setBlock(165, 12, Level.ROCK);
			setBlock(166, 12, Level.ROCK);
			...
			setBlock(181, 12, Level.TUBE_SIDE_LEFT);
			setBlock(182, 12, Level.TUBE_SIDE_RIGHT);
			setBlock(184, 12, Level.TUBE_SIDE_LEFT);
			setBlock(185, 12, Level.TUBE_SIDE_RIGHT);
			setBlock(189, 12, Level.TUBE_SIDE_LEFT);
			setBlock(190, 12, Level.TUBE_SIDE_RIGHT);
			...
			setBlock(181, 13, Level.TUBE_SIDE_LEFT);
			setBlock(182, 13, Level.TUBE_SIDE_RIGHT);
