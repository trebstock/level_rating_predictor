...
public class TestLevelB13 extends Level{
	...
	private static Random levelSeedRandom = new Random();
		...
		public TestLevelB13(int width, int height)
	    {
			super(width, height);
	    }


		public TestLevelB13(int width, int height, long seed, int difficulty, int type, GamePlay playerMetrics)
	    {
	        this(width, height);
	    ...
	    public void creat(long seed, int difficulty, int type)
	    {
			...
			setSpriteTemplate(29, 9, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
			setSpriteTemplate(121, 12, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
			setSpriteTemplate(25, 9, new SpriteTemplate(Enemy.ENEMY_GOOMBA, false));
			setSpriteTemplate(67, 12, new SpriteTemplate(Enemy.ENEMY_GOOMBA, false));
			setBlock(199, 5, Level.BLOCK_EMPTY);
			setSpriteTemplate(111, 12, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
			setBlock(185, 8, Level.ROCK);
			setBlock(189, 8, Level.BLOCK_EMPTY);
			setBlock(190, 8, Level.BLOCK_EMPTY);
			setBlock(191, 8, Level.BLOCK_EMPTY);
			setBlock(37, 9, Level.BLOCK_EMPTY);
			setBlock(38, 9, Level.BLOCK_EMPTY);
			setSpriteTemplate(62, 12, new SpriteTemplate(Enemy.ENEMY_GOOMBA, false));
			setBlock(89, 9, Level.ROCK);
			setBlock(90, 9, Level.BLOCK_EMPTY);
			setBlock(113, 9, Level.ROCK);
			setSpriteTemplate(153, 12, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
			setBlock(185, 9, Level.ROCK);
			setBlock(23, 10, Level.ROCK);
			setBlock(26, 10, Level.ROCK);
			setBlock(40, 10, Level.BLOCK_COIN);
			setBlock(41, 10, Level.BLOCK_EMPTY);
			setBlock(42, 10, Level.BLOCK_EMPTY);
			setBlock(49, 10, Level.ROCK);
			setBlock(86, 10, Level.ROCK);
			setBlock(88, 10, Level.ROCK);
			setBlock(89, 10, Level.ROCK);
			setBlock(115, 10, Level.BLOCK_POWERUP);
			setBlock(116, 10, Level.BLOCK_EMPTY);
			setBlock(133, 10, Level.ROCK);
			setBlock(161, 10, Level.ROCK);
			setBlock(191, 10, Level.BLOCK_EMPTY);
			setBlock(192, 10, Level.BLOCK_EMPTY);
			setBlock(193, 10, Level.BLOCK_EMPTY);
			setBlock(14, 11, Level.TUBE_TOP_LEFT);
			setBlock(15, 11, Level.TUBE_TOP_RIGHT);
			setBlock(20, 11, Level.ROCK);
			setBlock(21, 11, Level.ROCK);
			setBlock(22, 11, Level.ROCK);
			setBlock(23, 11, Level.ROCK);
			setBlock(24, 11, Level.ROCK);
			setBlock(25, 11, Level.ROCK);
			setBlock(26, 11, Level.ROCK);
			setBlock(27, 11, Level.ROCK);
			setBlock(28, 11, Level.ROCK);
			setBlock(29, 11, Level.ROCK);
			setBlock(30, 11, Level.ROCK);
			setBlock(42, 11, Level.ROCK);
			setBlock(43, 11, Level.ROCK);
			setBlock(44, 11, Level.ROCK);
			setBlock(45, 11, Level.ROCK);
			setBlock(46, 11, Level.ROCK);
			...
			setSpriteTemplate(54, 11, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
			setSpriteTemplate(55, 11, new SpriteTemplate(Enemy.ENEMY_GOOMBA, false));
			setBlock(65, 11, Level.TUBE_TOP_LEFT);
			setBlock(66, 11, Level.TUBE_TOP_RIGHT);
			setBlock(76, 11, Level.ROCK);
			setBlock(77, 11, Level.ROCK);
			setSpriteTemplate(80, 11, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
			setSpriteTemplate(81, 11, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
			setSpriteTemplate(83, 11, new SpriteTemplate(Enemy.ENEMY_GOOMBA, false));
			setBlock(86, 11, Level.ROCK);
			setBlock(87, 11, Level.ROCK);
			setBlock(88, 11, Level.ROCK);
			setBlock(89, 11, Level.ROCK);
			setBlock(90, 11, Level.ROCK);
			setBlock(91, 11, Level.ROCK);
			setBlock(92, 11, Level.ROCK);
			setBlock(93, 11, Level.ROCK);
			setBlock(94, 11, Level.ROCK);
			setBlock(95, 11, Level.ROCK);
			setSpriteTemplate(101, 11, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
			setBlock(133, 11, Level.TUBE_TOP_LEFT);
			setBlock(134, 11, Level.TUBE_TOP_RIGHT);
			setBlock(142, 11, Level.TUBE_TOP_LEFT);
			setBlock(143, 11, Level.TUBE_TOP_RIGHT);
			setBlock(151, 11, Level.TUBE_TOP_LEFT);
			setBlock(152, 11, Level.TUBE_TOP_RIGHT);
			setBlock(160, 11, Level.ROCK);
			setBlock(161, 11, Level.ROCK);
			setBlock(169, 11, Level.TUBE_TOP_LEFT);
			setBlock(170, 11, Level.TUBE_TOP_RIGHT);
			setSpriteTemplate(3, 12, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
			...
			setBlock(14, 12, Level.TUBE_SIDE_LEFT);
			setBlock(15, 12, Level.TUBE_SIDE_RIGHT);
			setBlock(19, 12, Level.ROCK);
			setBlock(20, 12, Level.ROCK);
			setBlock(21, 12, Level.ROCK);
			setBlock(22, 12, Level.ROCK);
			setBlock(23, 12, Level.ROCK);
			setBlock(24, 12, Level.ROCK);
			setBlock(25, 12, Level.ROCK);
			setBlock(26, 12, Level.ROCK);
			setBlock(27, 12, Level.ROCK);
			setBlock(28, 12, Level.ROCK);
			setBlock(29, 12, Level.ROCK);
			setBlock(30, 12, Level.ROCK);
			setBlock(31, 12, Level.ROCK);
			setBlock(32, 12, Level.ROCK);
			setBlock(33, 12, Level.ROCK);
			setBlock(34, 12, Level.ROCK);
			setBlock(35, 12, Level.ROCK);
			setBlock(36, 12, Level.BLOCK_EMPTY);
			setBlock(37, 12, Level.BLOCK_COIN);
			...
			setBlock(65, 12, Level.TUBE_SIDE_LEFT);
			setBlock(66, 12, Level.TUBE_SIDE_RIGHT);
			setBlock(76, 12, Level.ROCK);
			setBlock(77, 12, Level.ROCK);
			setBlock(78, 12, Level.ROCK);
			setBlock(79, 12, Level.ROCK);
			setBlock(80, 12, Level.ROCK);
			setBlock(81, 12, Level.ROCK);
			setBlock(82, 12, Level.ROCK);
			setBlock(83, 12, Level.ROCK);
			setBlock(84, 12, Level.ROCK);
			setBlock(85, 12, Level.ROCK);
			setBlock(86, 12, Level.ROCK);
			setBlock(87, 12, Level.ROCK);
			setBlock(88, 12, Level.ROCK);
			setBlock(89, 12, Level.ROCK);
			...
			setBlock(142, 12, Level.TUBE_SIDE_LEFT);
			setBlock(143, 12, Level.TUBE_SIDE_RIGHT);
			setSpriteTemplate(144, 12, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
			setBlock(151, 12, Level.TUBE_SIDE_LEFT);
			setBlock(152, 12, Level.TUBE_SIDE_RIGHT);
			setBlock(159, 12, Level.ROCK);
			setBlock(160, 12, Level.ROCK);
			setBlock(161, 12, Level.ROCK);
			setBlock(167, 12, Level.ROCK);
			setBlock(168, 12, Level.ROCK);
			setBlock(169, 12, Level.ROCK);
			...
			setBlock(116, 13, Level.HILL_TOP);
			setBlock(116, 14, Level.GROUND);
			setBlock(117, 13, Level.HILL_TOP);
			setBlock(117, 14, Level.GROUND);
