...
public class TestLevelB8 extends Level{
	...
	private static Random levelSeedRandom = new Random();
		...
		public TestLevelB8(int width, int height)
	    {
			super(width, height);
	    }


		public TestLevelB8(int width, int height, long seed, int difficulty, int type, GamePlay playerMetrics)
	    {
	        this(width, height);
	    ...
	    public void creat(long seed, int difficulty, int type)
	    {
			...
			setBlock(68, 4, Level.BLOCK_POWERUP);
			setBlock(133, 4, Level.ROCK);
			setBlock(146, 4, Level.BLOCK_EMPTY);
			setSpriteTemplate(48, 5, new SpriteTemplate(Enemy.ENEMY_GOOMBA, false));
			setBlock(119, 5, Level.BLOCK_EMPTY);
			setBlock(162, 5, Level.BLOCK_POWERUP);
			setBlock(42, 6, Level.BLOCK_COIN);
			setBlock(123, 6, Level.BLOCK_EMPTY);
			setBlock(124, 6, Level.BLOCK_EMPTY);
			setBlock(129, 6, Level.BLOCK_COIN);
			setBlock(178, 6, Level.BLOCK_POWERUP);
			setBlock(179, 6, Level.BLOCK_EMPTY);
			setBlock(180, 6, Level.BLOCK_EMPTY);
			setBlock(181, 6, Level.BLOCK_EMPTY);
			setBlock(182, 6, Level.BLOCK_EMPTY);
			setBlock(30, 7, Level.BLOCK_COIN);
			setBlock(40, 7, Level.BLOCK_COIN);
			setBlock(168, 7, Level.ROCK);
			setBlock(11, 8, Level.BLOCK_EMPTY);
			setBlock(55, 8, Level.ROCK);
			setBlock(109, 8, Level.BLOCK_EMPTY);
			setBlock(148, 8, Level.BLOCK_POWERUP);
			setBlock(166, 8, Level.ROCK);
			setBlock(168, 8, Level.ROCK);
			setBlock(8, 9, Level.ROCK);
			setBlock(55, 9, Level.ROCK);
			setBlock(166, 9, Level.ROCK);
			setBlock(168, 9, Level.ROCK);
			setBlock(199, 9, Level.BLOCK_EMPTY);
			setBlock(52, 10, Level.ROCK);
			setBlock(54, 10, Level.ROCK);
			setBlock(55, 10, Level.ROCK);
			setBlock(73, 10, Level.ROCK);
			setBlock(79, 10, Level.ROCK);
			setBlock(94, 10, (byte) (14 + 0 * 16));
			setBlock(166, 10, Level.ROCK);
			setBlock(168, 10, Level.ROCK);
			setBlock(195, 10, Level.ROCK);
			setBlock(10, 11, Level.BLOCK_EMPTY);
			setBlock(18, 11, (byte) (14 + 0 * 16));
			...
			setBlock(54, 11, Level.ROCK);
			setBlock(55, 11, Level.ROCK);
			setBlock(56, 11, Level.ROCK);
			setBlock(57, 11, Level.ROCK);
			...
			setBlock(67, 11, Level.ROCK);
			setBlock(68, 11, Level.ROCK);
			setBlock(69, 11, Level.ROCK);
			setBlock(70, 11, Level.ROCK);
			setBlock(73, 11, Level.ROCK);
			setBlock(77, 11, Level.ROCK);
			setBlock(78, 11, Level.ROCK);
			setBlock(79, 11, Level.ROCK);
			setBlock(88, 11, Level.TUBE_TOP_LEFT);
			setBlock(89, 11, Level.TUBE_TOP_RIGHT);
			setBlock(94, 11, (byte) (14 + 1 * 16));
			setBlock(111, 11, Level.TUBE_TOP_LEFT);
			setBlock(112, 11, Level.TUBE_TOP_RIGHT);
			setBlock(153, 11, Level.ROCK);
			setBlock(154, 11, Level.ROCK);
			setBlock(156, 11, Level.ROCK);
			setBlock(165, 11, Level.ROCK);
			setBlock(166, 11, Level.ROCK);
			setBlock(168, 11, Level.ROCK);
			setBlock(187, 11, Level.BLOCK_EMPTY);
			setBlock(193, 11, Level.ROCK);
			setBlock(194, 11, Level.ROCK);
			setBlock(195, 11, Level.ROCK);
			setBlock(196, 11, Level.ROCK);
			setBlock(197, 11, Level.ROCK);
			setBlock(198, 11, Level.ROCK);
			setBlock(199, 11, Level.ROCK);
			setBlock(18, 12, (byte) (14 + 1 * 16));
			setSpriteTemplate(31, 12, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
			...
			setSpriteTemplate(81, 12, new SpriteTemplate(Enemy.ENEMY_GOOMBA, false));
			setBlock(88, 12, Level.TUBE_SIDE_LEFT);
			setBlock(89, 12, Level.TUBE_SIDE_RIGHT);
			setBlock(94, 12, (byte) (14 + 2 * 16));
			setBlock(111, 12, Level.TUBE_SIDE_LEFT);
			setBlock(112, 12, Level.TUBE_SIDE_RIGHT);
			setBlock(121, 12, Level.ROCK);
			setSpriteTemplate(132, 12, new SpriteTemplate(Enemy.ENEMY_GOOMBA, false));
			setSpriteTemplate(133, 12, new SpriteTemplate(Enemy.ENEMY_GOOMBA, false));
			setSpriteTemplate(142, 12, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
			...
			setBlock(150, 12, Level.ROCK);
			setBlock(151, 12, Level.ROCK);
			setBlock(152, 12, Level.ROCK);
			setBlock(153, 12, Level.ROCK);
			setBlock(154, 12, Level.ROCK);
			setBlock(155, 12, Level.ROCK);
			setBlock(156, 12, Level.ROCK);
			setSpriteTemplate(157, 12, new SpriteTemplate(Enemy.ENEMY_GOOMBA, false));
			...
			setSpriteTemplate(177, 12, new SpriteTemplate(Enemy.ENEMY_GOOMBA, false));
			setSpriteTemplate(178, 12, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
			setSpriteTemplate(180, 12, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
			setBlock(193, 12, Level.ROCK);
			setBlock(194, 12, Level.ROCK);
			setBlock(195, 12, Level.ROCK);
			setBlock(196, 12, Level.ROCK);
			setBlock(197, 12, Level.ROCK);
			setBlock(198, 12, Level.ROCK);
			setBlock(199, 12, Level.ROCK);
